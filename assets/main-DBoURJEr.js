...
const vistaMain = {
  ...
  script: () => {
    ...
    document.querySelector("#btnAñadirComentario").addEventListener("click", () => {
      console.log("Estas añadiendo un comentario");
      const autor = document.querySelector("#autor").value;
      const fecha = document.querySelector("#fecha").value;
      const comentarioText = document.querySelector("#comentario").value;
      if (autor && fecha && comentarioText) {
        const nuevoComentarioHtml = comentario(autor, fecha, comentarioText);
        comentariosTexto.innerHTML += nuevoComentarioHtml;
